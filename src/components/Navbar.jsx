    ...
    <div>
      <nav className="bg-black  rounded-3xl border border-gray-500 top-0 left-0 w-full mb-96 flex items-center justify-between fixed px-8 py-3 lg:px-60 lg:py-4">
        ...
        <div className="flex items-center">
          <ul className="hidden md:flex items-center justify-center gap-4 mr-5 text-2xl">
            ...
            <a className=" hover:text-indigo-900 duration-500" href="#Education">Education</a>
            ...
            <a className="flex items-center gap-1 hover:text-indigo-900 duration-500" href="https://drive.google.com/file/d/1pGbqiqAIpiOqZKELNvxq6J5-LjI9Ge8c/view?usp=sharing" target="_blank"
      ...
      {isMenuOpen && (
        <ul className="md:hidden flex flex-col items-center fixed top-14 left-0 w-full backdrop-filter backdrop-blur border rounded-lg shadow-lg py-2">
          ...
          <li className="py-2">
            <a href="#Experiences" className=" block text-center w-full" onClick={toggleMenu}>Experiences</a>
          </li>
          <li className="py-2">
            <a href="#Education" className=" block text-center w-full" onClick={toggleMenu}>Education</a>
          </li>
          <li className="py-2">
